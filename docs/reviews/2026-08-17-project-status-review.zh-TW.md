...
**當日階段 0 補記：** 衛生工作落在 `docs/2026-08-17-status-sync`。README 已改為 `recipe.v1` 已實作，且 pyannote 在可選套件齊備時可跑。2026-05-18 音量／報告修改為 `08a165b`。CUDA `.to` 防護為 `86d9560`。該批未提交 diff 已不再是現況。新增回歸測試後收集數為 325（本機 314 passed、11 skipped）。
