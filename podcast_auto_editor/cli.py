...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_align.add_argument("--provider", default="mock", choices=("mock", "whisperx", "lattifai"), help="Alignment provider (mock ships offline; whisperx requires optional 'align-whisperx' dep group and a local phoneme model directory; see docs/runbooks/whisperx-alignment-setup.md; lattifai ONNX air-gap scaffolding shipped but decoding is blocked on k2 — see docs/runbooks/lattifai-onnx-setup.md)")
